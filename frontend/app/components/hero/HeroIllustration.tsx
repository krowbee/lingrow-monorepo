...
export function HeroIllustration({
  ...
  return (
    ...
    >
      <div className="hero-illustration-frame boder-white/10 to-white-2 absolute top-[16%] right-[8%] h-[580px] w-[430px] rounded-xl border bg-gradient-to-b from-white/8 shadow-[0_30px_120px_rgba(150,60,255,0.12)] backdrop-blur-sm" />
