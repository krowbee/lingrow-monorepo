...
export const AboutSection = () => {
    ...
    const cardContent = {
        0: {
            ...
            cardColor: { text: "text-green-500", border: "border-green-500" },
        },
        1: {
            ...
            cardColor: { text: "text-blue-500", border: "border-blue-500" },
        },
        2: {
            ...
            cardColor: { text: "text-red-500", border: "border-red-500" },
        },
        3: {
            ...
            cardColor: { text: "text-purple-500", border: "border-purple-500" },
        },
        4: {
            ...
            cardColor: { text: "text-pink-500", border: "border-pink-500" },
        },
        5: {
            ...
            cardColor: { text: "text-yellow-500", border: "border-yellow-500" },
        },
    ...
    return (
        <section className="about w-full flex flex-col items-center justify-center gap-10 pb-10 shadow-md">
            <h1 className="text-5xl flex text-white font-heading w-full h-20 justify-center items-center shadow-md font-heading">Про нас</h1>
            <div className="w-full justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-10 max-w-[1400px]">
                {Object.values(cardContent).map((card, index) => (
                    <InfoCard key={index} cardTitle={card.cardTitle} cardDescription={card.cardDescription} cardColor={card.cardColor} />
                ))}
            </div>
